...
> **榜单增长：第1名**: ZachGoldberg/Startup-CTO-Handbook  初创企业CTO手册
...
- 📝 项目描述： 一本涵盖领导力、管理和技术主题的书籍，专为软件工程团队领导者而写。这本手册提供了有关如何有效管理技术团队、领导创业公司技术决策以及应对技术挑战的实用建议。它是一本有关初创企业CTO角色的全面指南。
    ![]()
> **榜单增长：第2名**: dabeaz-course/python-mastery  高级Python精通课程
...
> **榜单增长：第3名**: microsoft/generative-ai-for-beginners  初学者的生成式人工智能课程
...
- 📝 项目描述： generative-ai-for-beginners是由Microsoft提供的生成式人工智能课程。该课程旨在帮助初学者理解和掌握生成式人工智能的基础概念和技术。通过实用的教程和示例，学习者可以逐步探索生成式人工智能的世界，为未来深入学习打下坚实基础。
    ![]()
> **榜单增长：第4名**: mlabonne/llm-course  大模型技术文章精选
...
> **榜单增长：第5名**: krahets/hello-algo  动画图解的数据结构与算法教程
...
> **榜单增长：第7名**: answerdev/answer  开源问答社区
...
> **榜单增长：第8名**: gibbok/typescript-book  TypeScript指南书籍
...
- 📝 项目描述： 一本全面而简洁地概述了TypeScript的功能的指南。它清晰解释了TypeScript语言的方方面面，从强大的类型系统到高级功能，涵盖了最新版本中的所有内容。无论您是初学者还是有经验的开发人员，这本书都是一个宝贵的资源，可以帮助您增强对TypeScript的理解和熟练程度。
    ![]()
> **榜单增长：第9名**: Visualize-ML/Book4_Power-of-Matrix  数学知识库
...
> **榜单增长：第10名**: hehonghui/awesome-english-ebooks  免费在线英语杂志及书籍
...
> **榜单增长：第11名**: ixahmedxi/noodle  开源教育平台
...
> **榜单增长：第12名**: AmazingAng/WTF-Solidity  Web3开发技巧和合约安全教程
...
> **榜单增长：第13名**: xiaolincoder/CS-Base  
...
> **榜单增长：第14名**: DataTalksClub/data-engineering-zoomcamp  数据工程课程
...
> **榜单增长：第15名**: PKUFlyingPig/cs-self-learning  计算机自学指南
...
> **榜单增长：第16名**: tangly1024/NotionNext  NextJS + Notion API 实现的静态博客
...
> **榜单增长：第17名**: dair-ai/ML-YouTube-Courses  YouTube最新的机器学习/人工智能课程
...
> **榜单增长：第18名**: microsoft/IoT-For-Beginners  微软物联网基础课程
...
> **榜单增长：第19名**: microsoft/AI-For-Beginners  微软人工智能课程
...
> **榜单增长：第20名**: microsoft/Data-Science-For-Beginners  微软数据科学课程
...
> **榜单增长：第23名**: microsoft/Web-Dev-For-Beginners  微软前端课程
...
> **榜单增长：第24名**: YSGStudyHards/DotNetGuide  C#/.NET面试指南
...
> **榜单增长：第25名**: cloudcommunity/Free-Certifications  免费课程和认证策划列表
...
目前start 3.5W
    ![]()
> **榜单增长：第28名**: andkret/Cookbook  数据工程师书籍
...
> **榜单增长：第29名**: microsoft/ai-edu  微软人工智能教育学习社区
...
> **榜单增长：第30名**: itwanger/toBeBetterJavaer   Java通俗易懂指南
...
> **榜单增长：第31名**: ruanyf/weekly  科技爱好者周刊
...
- 📝 项目描述： 科技爱好者周刊，每周五发布
    ![]()
> **榜单增长：第32名**: d2l-ai/d2l-en  交互式深度学习书与多框架代码
...
> **榜单增长：第33名**: OI-wiki/OI-wiki  编程竞赛知识教程
...
- 📝 项目描述： 免费、开放、持续更新的编程竞赛相关知识教程。包含竞赛的基础知识、常见题型、解题思路以及常用工具等内容，帮助大家更快速、深入地学习编程竞赛相关知识
    ![]()
> **榜单增长：第34名**: trimstray/the-book-of-secret-knowledge  信息集合与备忘录
...
> **榜单增长：第35名**: stefan-jansen/machine-learning-for-trading  
...
> **榜单增长：第36名**: codecrafters-io/build-your-own-x  构建自己的技术
...
- 📝 项目描述： 通过从头开始重新创建您最喜欢的技术，该项目旨在帮助开发者通过实践来掌握编程技能。通过参与重新创建喜欢的技术，开发者可以深入了解其工作原理、设计思路和实现细节，从而加深对编程的理解和掌握。
    ![]()
> **榜单增长：第37名**: federico-busato/Modern-CPP-Programming  现代C++编程课程
...
- 📝 项目描述： 一门面向现代C++编程的课程，旨在帮助学习者掌握C++的最新特性和最佳实践。该课程涵盖了C++语法、标准库、面向对象编程等方面，使学习者能够编写高效、现代化的C++代码。无论是初学者还是有经验的开发者，都可以通过这门课程提升自己在C++编程领域的技能。
    ![]()
> **榜单增长：第38名**: jackfrued/Python-100-Days  Python 100 天从新手到大师 
...
- 📝 项目描述： 一份适合新手入门的 Python 学习资料。这个学习计划为学习者提供了低学习曲线的学习路径，帮助他们从 Python 初学者逐步成为大师。不仅专业人士，即使是非专业人士也能通过这份资料轻松上手 Python 编程，掌握编程技能。
    ![]()
> **榜单增长：第39名**: binhnguyennus/awesome-scalability  软件系统架构设计
...
- 📝 项目描述： The Patterns of Scalable, Reliable, and Performant Large-Scale Systems
    ![]()
> **榜单增长：第40名**: 1c7/Crash-Course-Computer-Science-Chinese  计算机科学课程
...
> **榜单增长：第41名**: d2l-ai/d2l-zh  深度学习教学
...
- 📝 项目描述： 《动手学深度学习》：面向中文读者、能运行、可讨论。中英文版被70多个国家的500多所大学用于教学。
    ![]()
> **榜单增长：第42名**: byoungd/English-level-up-tips  英语进阶指南
...
> **榜单增长：第43名**: practical-tutorials/project-based-learning  项目驱动的编程学习
...
- 📝 项目描述： 编程教程仓库，这些教程分别使用不同的编程语言，从零构建应用程序。使读者通过实际项目案例，学习编译原理、操作系统、计算机网络、数据库等等。面向项目学习，比面向书本学习可操作性更高，更容易获得正向反馈
    ![]()
> **榜单增长：第44名**: ascoders/weekly  前端精读周刊
- 开源地址：https://github.com/ascoders/weekly
- 📅 开源时间：2017-03-20
- ⭐ 总星标数量：🔺28.8k⭐
- 📝 项目描述： 前端精读。前端界的好文精读，每周更新
    ![]()
> **榜单增长：第45名**: chaozh/awesome-blockchain-cn  
...
> **榜单增长：第46名**: CnTransGroup/EffectiveModernCppChinese  Effective Modern C++ 中文翻译版
...
> **榜单增长：第47名**: chinese-poetry/chinese-poetry  中华古诗词数据库
...
- 📝 项目描述： 这个项目收集了最全的中华古诗词数据库，包括唐宋两朝近一万四千位古诗人的作品，近5.5万首唐诗和26万首宋诗。此外，还包括了两宋时期1564位词人的21050首词。
    ![]()
> **榜单增长：第48名**: TheAlgorithms/Python   Python算法
...
> **榜单增长：第49名**: openai/gym  开源的强化学习环境库
...
> **榜单增长：第50名**: isocpp/CppCoreGuidelines  C++核心指南

...
### 项目(3)： krahets/hello-algo  动画图解的数据结构与算法教程
...
### 项目(4)： isno/theByteBook  字节手册
- 开源地址：https://github.com/isno/theByteBook
- 📅 开源时间：2022-10-08
- ⭐ 总星标数量：🔺7.9k⭐
- 📝 项目描述： 一个有价值的技术手册项目。theByteBook 涵盖了丰富的技术知识和实践经验，对于开发者和技术爱好者来说是一个很好的学习资源。
    ![](https://photocdn.tv.sohu.com/img/github/547677901.jpg)
### 项目(5)： answerdev/answer  开源问答社区
...
### 项目(6)： gibbok/typescript-book  TypeScript指南书籍
...
- 📝 项目描述： 一本全面而简洁地概述了TypeScript的功能的指南。它清晰解释了TypeScript语言的方方面面，从强大的类型系统到高级功能，涵盖了最新版本中的所有内容。无论您是初学者还是有经验的开发人员，这本书都是一个宝贵的资源，可以帮助您增强对TypeScript的理解和熟练程度。
    ![]()
### 项目(7)： Visualize-ML/Book4_Power-of-Matrix  数学知识库
...
### 项目(8)： hehonghui/awesome-english-ebooks  免费在线英语杂志及书籍
...
### 项目(10)： AmazingAng/WTF-Solidity  Web3开发技巧和合约安全教程
...
### 项目(11)： xiaolincoder/CS-Base  编程基础
- 开源地址：https://github.com/xiaolincoder/CS-Base
- 📅 开源时间：2022-03-20
- ⭐ 总星标数量：🔺15.2k⭐
- 🔺 上月增长数量：228⭐
- 📝 项目描述： 一个扎实的编程基础学习项目。xiaolincoder/CS-Base 为学习者提供了系统的计算机科学基础知识，包括数据结构、算法、操作系统等。通过这个项目，学习者可以打下坚实的编程基础，为进一步的学习和实践做好准备。
    ![](http://photocdn.tv.sohu.com/img/q_mini/20240731/pic_org_7e1248cc-3e6f-40ee-b401-bacd75e83453.png)
### 项目(12)： DataTalksClub/data-engineering-zoomcamp  数据工程课程
...
### 项目(13)： PKUFlyingPig/cs-self-learning  计算机自学指南
...
### 项目(14)： tangly1024/NotionNext  NextJS + Notion API 实现的静态博客
...
### 项目(15)： dair-ai/ML-YouTube-Courses  YouTube最新的机器学习/人工智能课程
...
### 项目(16)： microsoft/IoT-For-Beginners  微软物联网基础课程
...
### 项目(17)： microsoft/Data-Science-For-Beginners  微软数据科学课程
...
### 项目(18)： microsoft/ML-For-Beginners  微软机器学习课程
...
### 项目(19)： forthespada/CS-Books  计算机经典书籍和资源合集
...
### 项目(20)： YSGStudyHards/DotNetGuide  C#/.NET面试指南
...
### 项目(21)： cloudcommunity/Free-Certifications  免费课程和认证策划列表
...
目前start 3.5W
    ![]()
### 项目(24)： andkret/Cookbook  数据工程师书籍
...
### 项目(25)： microsoft/ai-edu  微软人工智能教育学习社区
...
### 项目(26)： itwanger/toBeBetterJavaer   Java通俗易懂指南
...
- 📝 项目描述： 科技爱好者周刊，每周五发布
    ![]()
### 项目(28)： trimstray/the-book-of-secret-knowledge  信息集合与备忘录
...
### 项目(29)： codecrafters-io/build-your-own-x  构建自己的技术
...
- 📝 项目描述： 通过从头开始重新创建您最喜欢的技术，该项目旨在帮助开发者通过实践来掌握编程技能。通过参与重新创建喜欢的技术，开发者可以深入了解其工作原理、设计思路和实现细节，从而加深对编程的理解和掌握。
    ![]()
### 项目(30)： federico-busato/Modern-CPP-Programming  现代C++编程课程
...
- 📝 项目描述： 一门面向现代C++编程的课程，旨在帮助学习者掌握C++的最新特性和最佳实践。该课程涵盖了C++语法、标准库、面向对象编程等方面，使学习者能够编写高效、现代化的C++代码。无论是初学者还是有经验的开发者，都可以通过这门课程提升自己在C++编程领域的技能。
    ![]()
### 项目(31)： jackfrued/Python-100-Days  Python 100 天从新手到大师 
...
- 📝 项目描述： 一份适合新手入门的 Python 学习资料。这个学习计划为学习者提供了低学习曲线的学习路径，帮助他们从 Python 初学者逐步成为大师。不仅专业人士，即使是非专业人士也能通过这份资料轻松上手 Python 编程，掌握编程技能。
    ![]()
### 项目(32)： binhnguyennus/awesome-scalability  软件系统架构设计
...
- 📝 项目描述： The Patterns of Scalable, Reliable, and Performant Large-Scale Systems
    ![]()
### 项目(33)： 1c7/Crash-Course-Computer-Science-Chinese  计算机科学课程
...
- 📝 项目描述： 《动手学深度学习》：面向中文读者、能运行、可讨论。中英文版被70多个国家的500多所大学用于教学。
    ![]()
### 项目(35)： byoungd/English-level-up-tips  英语进阶指南
...
### 项目(36)： practical-tutorials/project-based-learning  项目驱动的编程学习
...
- 📝 项目描述： 编程教程仓库，这些教程分别使用不同的编程语言，从零构建应用程序。使读者通过实际项目案例，学习编译原理、操作系统、计算机网络、数据库等等。面向项目学习，比面向书本学习可操作性更高，更容易获得正向反馈
    ![]()
### 项目(37)： ascoders/weekly  前端精读周刊
- 开源地址：https://github.com/ascoders/weekly
- 📅 开源时间：2017-03-20
- ⭐ 总星标数量：🔺28.9k⭐
- 📝 项目描述： 前端精读。前端界的好文精读，每周更新
    ![]()
### 项目(38)： chaozh/awesome-blockchain-cn  
...
### 项目(39)： CnTransGroup/EffectiveModernCppChinese  Effective Modern C++ 中文翻译版
...
### 项目(40)： chinese-poetry/chinese-poetry  中华古诗词数据库
...
- 📝 项目描述： 这个项目收集了最全的中华古诗词数据库，包括唐宋两朝近一万四千位古诗人的作品，近5.5万首唐诗和26万首宋诗。此外，还包括了两宋时期1564位词人的21050首词。
    ![]()
### 项目(41)： TheAlgorithms/Python   Python算法
...
### 项目(43)： isocpp/CppCoreGuidelines  C++核心指南
...
- 📝 项目描述： 一套关于C++编码的可靠指南、规则和最佳实践的合集。这些指南旨在帮助C++开发人员编写可读、高效、安全的代码。它提供了有关代码结构、内存管理、异常处理等方面的建议，有助于提高C++代码的质量和可维护性。如果您是C++开发人员，这些指南可能对您的项目非常有帮助。
    ![]()
### 项目(44)： angular/angular-cli  Angular的命令行工具
...
### 项目(45)： 3b1b/manim  数学动画的编程工具
- 开源地址：https://github.com/3b1b/manim
- 📅 开源时间：2015-03-23
- ⭐ 总星标数量：🔺74.9k⭐
- 🔺 上月增长数量：952⭐
- 📝 项目描述： 一个生成数学教学视频的动画引擎。它用编程的方式创建精美的数学动画，让数学更加易懂。效果如 
    ![](https://photocdn.tv.sohu.com/img/github/32689863.gif)
### 项目(46)： ripienaar/free-for-dev  程序员免费服务清单
- 开源地址：https://github.com/ripienaar/free-for-dev
- 📅 开源时间：2015-03-19
- ⭐ 总星标数量：🔺92.2k⭐
- 🔺 上月增长数量：438⭐
- 📝 项目描述： 专为程序员准备的免费服务清单。现在虽然有大量免费的服务，但大多数开发者很难找到它们，这是一份免费服务(SaaS、PaaS、IaaS 等)和产品的列表。
    ![]()
### 项目(47)： phodal/github  GitHub 漫游指南
- 开源地址：https://github.com/phodal/github
- 📅 开源时间：2015-03-09
- ⭐ 总星标数量：🔺10.3k⭐
- 📝 项目描述： 一本关于如何在GitHub上构建一个好项目的中文电子书。探索用户的行为，找一些感兴趣的东西。
    ![]()
### 项目(48)： yidao620c/python3-cookbook  Python Cookbook
...
本书作者是David Beazley大神，一位独立的计算机科学家、教育家，以及有着35年开发经验的软件开发者。 他在Python社区一直都很活跃，编写了很多的python包， 发表了很多的公开演讲视频 以及 编程教程。 同时还是Python Essential Reference 以及 Python Cookbook (O'Reilly Media)的作者。
    ...
    ![]()
### 项目(49)： iluwatar/java-design-patterns  Java 设计模式最佳实践
...
- 📝 项目描述： 提供了一系列 Java 设计模式的最佳实践示例，帮助程序员在设计应用程序或系统时解决常见问题，同时通过经过验证的开发示例来加速开发过程。这是一个有助于设计和编写高质量代码的宝贵资源。
    ![]()
### 项目(50)： ochococo/Design-Patterns-In-Swift  
